...
//  WhaleTalk
//
//  Created by Eliot Arntz on 12/2/15.
...
class ChatViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.registerClass(MessageCell.self, forCellReuseIdentifier: cellIdentifer)
        ...
        let tableViewConstraints: [NSLayoutConstraint] = [        tableView.topAnchor.constraintEqualToAnchor(topLayoutGuide.bottomAnchor),
    ...
    func updateBottomConstraint(notification: NSNotification) {
        if let
            ...
            animationaDuration = userInfo[UIKeyboardAnimationDurationUserInfoKey]?.doubleValue {
                let newFrame = view.convertRect(frame, fromView: (UIApplication.sharedApplication().delegate?.window)!)
                bottomConstraint.constant = newFrame.origin.y - CGRectGetHeight(view.frame)
                UIView.animateWithDuration(animationaDuration, animations: {
...
extension ChatViewController: UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifer, forIndexPath: indexPath) as! MessageCell
